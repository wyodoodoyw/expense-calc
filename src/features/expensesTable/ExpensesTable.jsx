    ...
    <table className="table table-striped table-bordered mt-3 text-center ">
      <tbody>
        ...
        {/* {usLayovers && (
          <>
            <tr>
              <th>{usLayovers[0].layoverStation}</th>
              <th>Breakfast</th>
              <th>Lunch</th>
              <th>Dinner</th>
              <th>Snack</th>
            ...
            <tr className="table-primary">
              <td>Total:</td>
              <td colSpan={5}>
                ${calculateUsDisplayTotal(usMeals, usExpenses)}
              </td>
            </tr>
            <tr className="table-primary">
              <td>Grand Total:</td>
              <td colSpan={5}>
                $
                {Number(calculateCaDisplayTotal(caMeals, caExpenses)) +
                  Number(calculateUsDisplayTotal(usMeals, usExpenses))}
              </td>
            </tr>
          </>
        )} */}
